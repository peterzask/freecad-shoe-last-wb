...
doc, sketch_xs4 = hf.Doc_Sketch(doc_name, sketch_name)
...
class xs_4_lens_c:
    def __init__(self, p_lens:     last_profile.profile_lengths_c,
        ...
        # HC from front_bc/xs_4 plane intersection in global 3D
        ...
        g_C = hf.get_bspline_plane_intersection_new(
            front_bc_3d, xs_base.xs_4_placement.Base, xs_base.xs_3_normal)[0]
        hf.p_vec(g_C, "xs_4 g_C")
        self.HC  = (g_C - xs_base.xs_4_placement.Base).dot(xs_base.gvec_K_I)
