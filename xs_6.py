...
doc, sketch_xs6 = hf.Doc_Sketch(last_insole.doc, sketch_name)
...
class xs_6_lens_c:
    def __init__(self, p_lens:     last_profile.profile_lengths_c,
        ...
        # HC from front_bc/xs_6 plane intersection in global 3D
        ...
        g_C = hf.get_bspline_plane_intersection_new(
            front_bc_3d, xs_base.xs_6_placement.Base, xs_base.gvec_uJB1)[0]
        hf.p_vec(g_C, "xs_6 g_C")
        self.HC  = (g_C - xs_base.xs_6_placement.Base).dot(xs_base.gvec_uJB1_localY)
