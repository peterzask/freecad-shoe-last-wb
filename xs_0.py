...
class xs_0_lens_c:
    def __init__(self, p_lens:     last_profile.profile_lengths_c,
        ...
        poles_3d = [last_profile.sketch_profile.Placement.multVec(p)
                    for p in control_curves.toe_profile.getPoles()]
        top_bc_3d = Part.BSplineCurve()
        top_bc_3d.buildFromPolesMultsKnots(
            poles_3d,
            control_curves.toe_profile.getMultiplicities(),
            control_curves.toe_profile.getKnots(),
            False, control_curves.toe_profile.Degree)
