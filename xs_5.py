...
sketch_name = "Sketch_xs_5"
doc, sketch_xs5 = hf.Doc_Sketch(last_insole.doc, sketch_name)
...
class xs_5_lens_c:
    def __init__(self, p_lens:      last_profile.profile_lengths_c,
        ...
        # HC from front_bc/xs_5 plane intersection in global 3D
        ...
        g_C = hf.get_bspline_plane_intersection_new(
            front_bc_3d, xs_base.xs_5_placement.Base, xs_base.xs_5_normal)[0]
        hf.p_vec(g_C, "xs_5 g_C")
        self.HC  = (g_C - xs_base.xs_5_placement.Base).dot(xs_base.gvec_J1_J)
        self.CC1 = xs_base.xs_5.CC1
        self.CC2 = xs_base.xs_5.CC2
        self.HC1 = xs_base.xs_5.HC1
        self.HC2 = xs_base.xs_5.HC2

    def build(self):
        sc    = xs_base.xs_5
        _H_y  = (sc.H  - xs_base.xs_5_placement.Base).dot(xs_base.gvec_J1_J)
        _H3_y = (sc.H3 - xs_base.xs_5_placement.Base).dot(xs_base.gvec_J1_J)
...
# --- Build and draw ---
xs_5 = xs_5_lens_c(last_profile.p_lens, last_insole.insole_lens,
                   last_profile.profile_dwg)
xs_5.build()
xs_5.draw_circles(sketch_xs5)
xs_5.draw_lines(sketch_xs5)

plen, plen_in = xs_5.perimeter_length()
print(f"xs_5 perimeter = {plen:.1f} mm  ({plen_in:.3f} in)")

sketch_xs5.Placement = xs_base.xs_5_placement * hf.yz_xy_place
